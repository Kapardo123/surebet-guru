...
export async function GET() {
  try {
    // Full Chrome header set — SportyTrader/Cloudflare score requests missing
    // sec-fetch-*/sec-ch-ua hints as bots and serve the hideodd variant
    // (identical listing, every odd="X" attribute stripped).
