...
const Logo = () => {
  ...
  return (
    <>
      <div className="select-none cursor-pointer flex items-baseline gap-0.5" onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleTap(); }}>
        <span className="text-xl font-black tracking-tighter bg-gradient-to-r from-primary via-[hsl(280,80%,65%)] to-accent bg-[length:200%_100%] animate-[shimmer_3s_ease-in-out_infinite] bg-clip-text text-transparent">
          GREAT
        </span>
