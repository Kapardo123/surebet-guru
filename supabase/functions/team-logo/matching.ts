// ============================================================================
// Team-name matching for the `team-logo` edge function.
// Mirrors src/lib/teamNameMatch.ts (kept standalone so the function bundles
// without reaching into the client source tree).
// ============================================================================
